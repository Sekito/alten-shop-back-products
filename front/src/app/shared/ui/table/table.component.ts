...
export class TableComponent<T> implements OnChanges {
  ...
  public entryDeletionDialogDisplayed = false;
  ...
  public onDelete(id: number): void {
    this.entryDeletionDialogDisplayed = true;
    this.idToDelete = id
  ...
  public onDeleteEntry(id: number): void{
    if(this.idToDelete){
      this.deleted.emit([this.idToDelete])
      this.idToDelete = null;
    }
    this.entryDeletionDialogDisplayed = false;
  }
